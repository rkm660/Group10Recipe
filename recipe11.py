...
def getIngredients(url):
    ...
    for element in allIngredientElements:
        if not ('ingred-heading' in str(element)):
...
def main(args):
    ...
    outFileName = 'Group10.json'
    url = 'http://allrecipes.com/Recipe/Easy-Garlic-Broiled-Chicken/'
#    url = 'http://allrecipes.com/Recipe/Meatloaf'
#    url = 'http://allrecipes.com/Recipe/Chicken-Parmigiana'
#    url = 'http://allrecipes.com/Recipe/Baked-Denver-Omelet'
#    url = 'http://allrecipes.com/Recipe/Chicken-Alfredo'
#    url = 'http://allrecipes.com/Recipe/Jambalaya'
#    url = 'http://allrecipes.com/Recipe/Country-Beef-Short-Ribs-and-Rosemary-Polenta'
